...
export const AGENT_CONFIGS: Record<AgentId, AgentConfig> = {
  ...
  waste_reduction: {
    ...
    icon: "recycle",
    color: "violet",
    description: "Analyses expiry dates and suggests ways to reduce food waste",
  },
};
...
export const AGENT_STYLES: Record<AgentId, { badge: string; bg: string; text: string }> = {
  ...
  waste_reduction: { badge: "bg-violet-100 text-violet-700 border-violet-200",   bg: "bg-violet-50",  text: "text-violet-700" },
};
